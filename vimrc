...
"常规配置"
set guifont=Courier_New:h14      " 字体 && 字号
...
" 设置编码
set fileencodings=utf-8,gbk,ucs-bom,default,cp936,latin-1
...
let g:template_path='/Users/creturn/.vim/template/'

" :AuthorInfoDetect   自动添加作者、时间等信息，本质是NERD_commenter && authorinfo的结合
let g:vimrc_author='Creturn'
let g:vimrc_email='master@creturn.com'
let g:vimrc_homepage='http://www.creturn.com'
...
" tl                  打开Taglist [非插入模式]
map tl :Tlist<CR><c-l>
" ctrl + l 使用zencoding ctry+y+,
imap <a-l> <ESC>:call zencoding#expandAbbr(0)<CR>a
" ======= 编译 && 运行 ======= "
...
" Ctrl + R 一键保存、运行
map <c-b> :call RunCode()<CR>
imap <c-b> <ESC>:call RunCode()<CR>
vmap <c-b> <ESC>:call RunCode()<CR>
set vb t_vb=
"F11 Gvim全屏问题 需要安装 wmcrl apt-get install wmctrl
let g:fullscreen = 0
...
""set cursorcolumn
"自动补全"
autocmd filetype php setlocal dict+=~/.vim/dic/php_function_list.txt
